            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 mb-12 sm:mb-16">
                    ...
                    <div className="bg-gray-950 rounded-2xl p-4 sm:p-8">
                        <img className="w-full rounded-lg sm:rounded-2xl mb-4" src="../../public/img/Titanio Premium.jpg" alt="iphoneTitanio" />
                    ...
                    <div className="bg-gray-950 rounded-2xl p-4 sm:p-8">
                        <img className="w-full rounded-lg sm:rounded-2xl mb-4" src="../../public/img/ios 19.webp" alt="iosiPhone" />
                ...
                <div className="bg-gray-950 p-6 sm:p-12 rounded-2xl mb-12 relative" id="performance">
                    ...
                    <img className="w-full rounded-lg sm:rounded-t-2xl" src="../../public/img/iphone-17-pro_destak.webp" alt="iPhone 17 Pro" />
